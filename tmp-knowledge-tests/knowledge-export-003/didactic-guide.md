...
- Files analyzed: 19
- Generated: 2026-04-07T21:22:31.687Z
...
- Foco didatico: Ao estudar, foque em quais tabelas sao lidas/escritas e quais filtros influenciam resultado e desempenho.
- Estruturas detectadas: imports: 4 | possui comandos SQL
...
- Estruturas detectadas: funcoes: parseArgs, toMode, sanitizeText, stripHtml, inferLanguage, classifyFile, isTextCandidate, collectFiles | imports: 5 | possui sinais de API/rotas | possui comandos SQL
...
- Utilidade: Este arquivo contem logica de acesso ou manipulacao de dados no banco, definindo como informacoes sao consultadas e alteradas.
- Foco didatico: Ao estudar, foque em quais tabelas sao lidas/escritas e quais filtros influenciam resultado e desempenho.
- Estruturas detectadas: possui comandos SQL
...
- Utilidade: Este arquivo contem logica de acesso ou manipulacao de dados no banco, definindo como informacoes sao consultadas e alteradas.
- Foco didatico: Ao estudar, foque na entrada, transformacao e saida de cada funcao para dominar o raciocinio do codigo.
- Estruturas detectadas: funcoes: normalizeMarkdown, parseArgs, parseMode, splitSections, estimateWords, getTailWords, chunkSection, buildChunks | imports: 2 | possui comandos SQL
...
- Utilidade: Este arquivo contem logica de acesso ou manipulacao de dados no banco, definindo como informacoes sao consultadas e alteradas.
- Foco didatico: Ao estudar, foque na entrada, transformacao e saida de cada funcao para dominar o raciocinio do codigo.
- Estruturas detectadas: funcoes: getDataDir, getBackupDir, nowStamp, resolveDatabaseFile, copyIfExists, run, pad | imports: 3 | possui comandos SQL
