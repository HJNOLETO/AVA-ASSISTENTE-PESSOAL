...
public:
    ...
    static TSharedPtr<FJsonObject> AddGetNode(const TSharedPtr<FJsonObject>& Params);

    static TSharedPtr<FJsonObject> AddCallFunctionOnObject(const TSharedPtr<FJsonObject>& Params);
