...
public:
     ...
     * @param Params JSON containing blueprint_name, node_id, pin_name, direction
     * @return JSON with success and broken connection details
     */
    static TSharedPtr<FJsonObject> DisconnectPins(const TSharedPtr<FJsonObject>& Params);
