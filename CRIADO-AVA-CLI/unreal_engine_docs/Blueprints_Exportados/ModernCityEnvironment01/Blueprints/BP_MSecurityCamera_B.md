# 🎮 Blueprint: BP_MSecurityCamera_B
...
### 📌 Grafo: `ExecuteUbergraph_BP_MSecurityCamera_B`

### 📌 Grafo: `UserConstructionScript_MERGED`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `BP_MSecurityCamera_B`?
- Quais funções e eventos são chamados no grafo do `BP_MSecurityCamera_B`?