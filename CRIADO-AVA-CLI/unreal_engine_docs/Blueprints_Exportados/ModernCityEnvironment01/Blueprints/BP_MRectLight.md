...
### 📌 Grafo: `ExecuteUbergraph_BP_MRectLight`

### 📌 Grafo: `UserConstructionScript_MERGED`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `BP_MRectLight`?
- Quais funções e eventos são chamados no grafo do `BP_MRectLight`?