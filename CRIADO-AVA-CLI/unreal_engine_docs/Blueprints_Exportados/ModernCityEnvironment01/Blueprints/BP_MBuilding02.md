...
### 📌 Grafo: `ExecuteUbergraph_BP_MBuilding02`

### 📌 Grafo: `UserConstructionScript_MERGED`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `BP_MBuilding02`?
- Quais funções e eventos são chamados no grafo do `BP_MBuilding02`?