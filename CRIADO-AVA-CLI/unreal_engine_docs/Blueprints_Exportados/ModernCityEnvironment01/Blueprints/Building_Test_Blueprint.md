# 🎮 Blueprint: Building_Test_Blueprint
...
### 📌 Grafo: `ExecuteUbergraph_Building_Test_Blueprint`

### 📌 Grafo: `UserConstructionScript_MERGED`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `Building_Test_Blueprint`?
- Quais funções e eventos são chamados no grafo do `Building_Test_Blueprint`?