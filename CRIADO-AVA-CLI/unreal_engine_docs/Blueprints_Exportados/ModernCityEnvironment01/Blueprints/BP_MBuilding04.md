...
### 📌 Grafo: `ExecuteUbergraph_BP_MBuilding04`

### 📌 Grafo: `UserConstructionScript_MERGED`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `BP_MBuilding04`?
- Quais funções e eventos são chamados no grafo do `BP_MBuilding04`?