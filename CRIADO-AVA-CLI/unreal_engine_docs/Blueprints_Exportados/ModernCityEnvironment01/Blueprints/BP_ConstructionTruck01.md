# 🎮 Blueprint: BP_ConstructionTruck01
...
### 📌 Grafo: `ExecuteUbergraph_BP_ConstructionTruck01`

### 📌 Grafo: `UserConstructionScript_MERGED`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `BP_ConstructionTruck01`?
- Quais funções e eventos são chamados no grafo do `BP_ConstructionTruck01`?