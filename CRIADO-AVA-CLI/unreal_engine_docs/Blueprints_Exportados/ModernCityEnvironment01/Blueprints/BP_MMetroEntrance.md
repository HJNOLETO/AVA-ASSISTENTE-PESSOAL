...
### 📌 Grafo: `ExecuteUbergraph_BP_MMetroEntrance`

### 📌 Grafo: `UserConstructionScript_MERGED`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `BP_MMetroEntrance`?
- Quais funções e eventos são chamados no grafo do `BP_MMetroEntrance`?