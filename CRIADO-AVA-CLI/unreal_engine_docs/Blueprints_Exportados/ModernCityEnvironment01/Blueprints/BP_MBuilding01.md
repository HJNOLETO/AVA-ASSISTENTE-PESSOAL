...
### 📌 Grafo: `ExecuteUbergraph_BP_MBuilding01`

### 📌 Grafo: `UserConstructionScript_MERGED`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `BP_MBuilding01`?
- Quais funções e eventos são chamados no grafo do `BP_MBuilding01`?