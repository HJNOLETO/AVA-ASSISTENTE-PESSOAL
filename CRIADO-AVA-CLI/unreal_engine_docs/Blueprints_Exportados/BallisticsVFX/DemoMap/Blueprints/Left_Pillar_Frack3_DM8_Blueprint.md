# 🎮 Blueprint: Left_Pillar_Frack3_DM8_Blueprint
...
- 🟢 `BndEvt__DestructibleComponent_K2Node_ComponentBoundEvent_259_ComponentFractureSignature__DelegateSignature`
...
- Qual é a classe pai do Blueprint `Left_Pillar_Frack3_DM8_Blueprint`?
- Quais funções e eventos são chamados no grafo do `Left_Pillar_Frack3_DM8_Blueprint`?