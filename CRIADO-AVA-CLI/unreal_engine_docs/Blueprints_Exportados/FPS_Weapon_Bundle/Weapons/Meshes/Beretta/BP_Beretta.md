# 🎮 Blueprint: BP_Beretta

**[Classe Pai / Parent Class: `BP_WeaponBase_C`]**
...
### 📌 Grafo: `ExecuteUbergraph_BP_Beretta`

## ❓ Perguntas que este documento responde
- Qual é a classe pai do Blueprint `BP_Beretta`?
- Quais funções e eventos são chamados no grafo do `BP_Beretta`?